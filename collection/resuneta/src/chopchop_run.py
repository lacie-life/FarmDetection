...
read_prefix = r'/media/lacie-life/Data/datasets/ISPRS_BENCHMARK_DATASETS/Potsdam/'
...
prefix_global_write = r'/media/lacie-life/Data/datasets/ISPRS_BENCHMARK_DATASETS/Potsdam/Data_6k/'
