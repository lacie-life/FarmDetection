...
class batch_ser_func():
    ...
    def singleband_oldversion(self):
        ...
        if 'Band1' not in originbands:
            ...
            image = cv2.resize(Red, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
        ...
        if 'Band2' not in originbands:
            ...
            image = cv2.resize(Green, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
        ...
        if 'Band3' not in originbands:
            ...
            image = cv2.resize(Blue, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
        ...
        if 'VEG' not in originbands:
            ...
            image = cv2.resize(VEG, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
        ...
        if 'CIVE' not in originbands:
            ...
            image = cv2.resize(CIVE, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
            # image=image.reshape((int(bandsize[1]/ratio),int(bandsize[0]/ratio),3))
        ...
        if 'MExG' not in originbands:
            ...
            image = cv2.resize(MExG, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
            # image=image.reshape((int(bandsize[1]/ratio),int(bandsize[0]/ratio),3))
        ...
        if 'NDVI' not in originbands:
            ...
            image = cv2.resize(NDVI, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
            # image=image.reshape((int(bandsize[1]/ratio),int(bandsize[0]/ratio),3))
        ...
        if 'NGRDI' not in originbands:
            originbands.update(tempdict)
            image = cv2.resize(NGRDI, (int(bandsize[1] / ratio), int(bandsize[0] / ratio)),
                               interpolation=cv2.INTER_LINEAR)
            # image=image.reshape((int(bandsize[1]/ratio),int(bandsize[0]/ratio),3))
